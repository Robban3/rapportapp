...
Notera att pg_cron kör som databasägare, inte som en inloggad admin.
`skapa_pass_fran_schema` kontrollerar `ar_admin()`, så den vägen fungerar bara
för en inloggad administratör — vill du schemalägga generatorn behöver anropet
gå via en wrapper som sätter rätt roll.
